# Django settings for rapidsms_opsmile project.

import os

# The top directory for this project. Contains requirements/, manage.py,
# and README.rst, a rapidsms_opsmile directory with settings etc (see
...
SECRET_KEY = 'w_qm2*&#7f7gyc%05v*!($f(vtb&z+_l=m=-@ag&ye@ud$$8(4'
...
ROOT_URLCONF = 'rapidsms_opsmile.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'rapidsms_opsmile.wsgi.application'
